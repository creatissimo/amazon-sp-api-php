 ...
 *
 * @category    Class
 * @description Contains price information about the product, including the LowestPrices and BuyBoxPrices, the ListPrice, the
...
class Summary implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'competitive_price_threshold'         => '\ClouSale\AmazonSellingPartnerAPI\Models\ProductPricing\MoneyType',
     ...
     *
     * @param \ClouSale\AmazonSellingPartnerAPI\Models\ProductPricing\MoneyType $competitive_price_threshold competitive_price_threshold
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $offers_available_time When the status is ActiveButTooSoonForProcessing, this is the time when the offers will be available
     *                                         for processing.
     *
     * @return $this
     */
